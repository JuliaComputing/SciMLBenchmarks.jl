...
benchmarks = [
    # ("Alkan_SciSignal2018", "hash123", :auto),  # Requires https://github.com/LCSB-BioCore/SBML.jl merged.
    ...
    # ("Bertozzi_PNAS2020", "hash123", :auto),  # multiple different observableParameter overrides not supported
    ...
    # ("Bruno_JExpBot2016", "hash123", :auto),  # multiple different observableParameter overrides not supported
    # ("Chen_MSB2009", "hash123", :auto),  # multiple different observableParameter overrides not supported
    # ("Crauste_CellSystems2017", "hash123", :auto),  # multiple different observableParameter overrides not supported
    ("Elowitz_Nature2000", "hash123", :auto),
    # ("Fiedler_BMC2016", "hash123", :auto),  # multiple different observableParameter overrides not supported
    # ("Froehlich_CellSystems2018", "hash123", :auto),  # Postequilibration not yet supported
    # ("Fujita_SciSignal2010", "hash123", :auto),  # multiple different observableParameter overrides not supported
    ...
    # ("SalazarCavazos_MBoC2020", "hash123", :auto),  # multiple different observableParameter overrides not supported
    # ("Schwen_PONE2014", "hash123", :auto),  # multiple different observableParameter overrides not supported
    ...
    # ("Zhao_QuantBiol2020", "hash123", :auto),  # multiple different observableParameter overrides not supported
    # ("Zheng_PNAS2012", "hash123", :auto)  # Preequilibration not yet supported
]

# benchmarks = [("Giordano_Nature2020", "hash123", :auto)]
...
cases = [Base.product(benchmarks, optim_methods)...]
